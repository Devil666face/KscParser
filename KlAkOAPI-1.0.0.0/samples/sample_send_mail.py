...
"""This module presents samples of usage KlAkOAPIWrapperLib package to send mail"""
...
def main():
    ...
    oOptions = KlAkOAPI.Params.KlAkParams({'MailRecipients': ['Anna.Degtyareva@kaspersky.com'], 'MailSubject': 'Test qr-code email message', 'MailBodyType': 'html'})
